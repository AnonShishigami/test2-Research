...
class CurveV2(BaseLiquidityProvider):
    ...
    def update_01(self, trade_01):
        if trade_01 == 1:
            try:
                ...
                self.inventories[0] = self.smart_contract.balances[0] / curve_v2_swap.PRECISION
                self.inventories[1] = self.smart_contract.balances[1] / curve_v2_swap.PRECISION
    ...
    def arb_01(self, swap_price_01, relative_cost, fixed_cost, step_ratio=10000):
            return super().arb_01(swap_price_01, relative_cost, fixed_cost, step_ratio=step_ratio)

    def arb_10(self, swap_price_10, relative_cost, fixed_cost, step_ratio=10000):
            return super().arb_10(swap_price_10, relative_cost, fixed_cost, step_ratio=step_ratio)
