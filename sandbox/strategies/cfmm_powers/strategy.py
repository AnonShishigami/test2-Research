...
class CFMMPowers(BaseLiquidityProvider):
    ...
    @staticmethod
    def get_cfmm_powers_amount_in(r_in, w_in, r_out, w_out, amount_out, delta, liquidity):
    ...
    def get_cfmm_powers_price(self, r_in, w_in, r_out, w_out, amount_out, delta, *args, **kwargs):
        ...
        return self.get_cfmm_powers_amount_in(r_in, w_in, r_out, w_out, amount_out, delta, liquidity) / amount_out
